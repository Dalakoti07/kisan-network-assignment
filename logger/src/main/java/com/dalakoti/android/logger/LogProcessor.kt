package com.dalakoti.android.logger

import com.dalakoti.android.logger.annotation.LogData
import com.dalakoti.android.logger.processor.base.BaseProcessor
import com.dalakoti.android.logger.processor.events.EventsClassGenerator
import com.dalakoti.android.logger.processor.events.GroupedClassEvents
import com.dalakoti.android.logger.processor.events.OnEventAnnotatedMethod
import com.dalakoti.android.logger.processor.events.OnEventAnnotationValidator
...
class LogProcessor : BaseProcessor(){
    ...
    override fun process(
        ...
        roundEnv?.getElementsAnnotatedWith(LogData::class.java)
            ?.forEach { element ->
